...
=======
    "Browse our gallery of community sessions, awareness work, Wajir CVE forum imagery, and wider engagement activities.",
...
=======
        description="This gallery brings together images from our awareness sessions, Wajir CVE forum activities, albinism support work, and wider community engagement."
      />
      <div className="mt-8 border border-[var(--color-sand-line)] bg-[var(--color-surface)] px-5 py-5 text-sm leading-7 text-[var(--color-muted)] sm:px-6">
        Our gallery highlights the areas we return to most often in our work: inclusion, community learning, dialogue, youth engagement, and resilience.
>>>>>>> 9c0841dcfc3b1144e0a56c0475ba32eeb1e1097c
      </div>
